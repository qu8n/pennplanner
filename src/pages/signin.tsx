    ...
    <>
      <div className="flex w-1/2 flex-col items-center justify-center">
        ...
        <p className="max-w-sm text-center text-xs text-neutral-400">
          ...
          <b>wgusduhubrpononyltwn.supabase.co</b> with your Google account.
          Supabase is a{' '}
          <Link
            isExternal={true}
            underline="hover"
          ...
          PennPlanner will collect your (1) full name and (2) email address as
          provided by Google.
        </p>
      </div>
      ...
      <div className="flex flex-col items-start justify-center gap-2 px-56">
        ...
        >
          ...
          <Radio value="Dual Degree" isDisabled>
            <span className="font-semibold text-neutral-700">Dual Degree</span>{' '}
            (coming soon)
          </Radio>
        </RadioGroup>
